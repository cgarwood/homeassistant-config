...
class Presence(hass.Hass):
    ...
    def initialize(self):
        ...
        self.listen_state(self.handle_presence, "device_tracker.charless_iphone")
        self.listen_state(self.handle_presence, "device_tracker.tinas_iphone")
    ...
    def get_person_by_entity_id(self, entity):
        if (entity == "device_tracker.charless_iphone" or entity == "input_select.charles_status"): person = "charles"
        elif (entity == "device_tracker.tinas_iphone" or entity == "input_select.tina_status"): person = "tina"
        else: person = "unknown"
        return person